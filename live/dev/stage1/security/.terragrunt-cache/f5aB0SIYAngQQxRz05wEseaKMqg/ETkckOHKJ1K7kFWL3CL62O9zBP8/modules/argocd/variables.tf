...
variable "kubeconfig_path" {
  description = "Absolute path to the kubeconfig file. Passed to the nginx NLB IP resolver script and Kubernetes providers via the Terragrunt generate block."
  type        = string
  default     = "~/.kube/config"
}
